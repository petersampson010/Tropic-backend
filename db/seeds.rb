...
PlantGrowth.create(name: "Guava", germinate_s: 0.5, fruiting_s: 24, fruiting_f: 36, harvest_s: 26, harvest_f: 39)
...
PlantGrowth.create(name: "Jambolan", germinate_s: 0.5, fruiting_s: 60, fruiting_f: 84, harvest_s: 64, harvest_f: 88)
PlantGrowth.create(name: "Java Apple")
PlantGrowth.create(name: "Kiwi", fruiting_s: 36, fruiting_f: 48, harvest_s: 48, harvest_f: 60)
PlantGrowth.create(name: "Langsat", germinate_s: 0.5, germinate_f: 0.75, fruiting_s: 84, harvest_s: 120)
PlantGrowth.create(name: "Curry Leaf", germinate_s: 0.3, harvest_s: 12, harvest_f: 24)
PlantGrowth.create(name: "Lime", fruiting_s: 36, fruiting_f: 72, harvest_s: 96, harvest_f: 120)
PlantGrowth.create(name: "Longan", germinate_s: 0.2, outside_s: 24, outside_f: 36)
...
PlantGrowth.create(name: "Mango", germinate_s: 0.5, germinate_f: 1, fruiting_s: 55, harvest_s: 60)
PlantGrowth.create(name: "Mangosteen", sprouting_s: 0.8, harvest_s: 24, harvest_f: 36)
PlantGrowth.create(name: "Moringa", bloom_s: 8)
PlantGrowth.create(name: "Naranjilla", bloom_s: 5, fruiting_s: 10, fruiting_f: 12)
PlantGrowth.create(name: "Neem", germinate_s: 0.25, germinate_f: 0.75, fruiting_s: 36, fruiting_f: 60, maturity_s: 120)
PlantGrowth.create(name: "Nutmeg", harvest_s: 84, harvest_f: 109, maturity_s: 240)
PlantGrowth.create(name: "Okra", germinate_s: 0.1, germinate_f: 0.5, harvest_s: 2.5, harvest_f: 3)
...
PlantGrowth.create(name: "Rambutan", germinate_s: 0.5, fruiting_s: 60, fruiting_f: 72, harvest_s: 120)
PlantGrowth.create(name: "Rosemary", germinate_s: 0.5, germinate_f: 0.6)
...
PlantGrowth.create(name: "Karela", germinate_s: 0.3, harvest_s: 3)
...
PlantGrowth.create(name: "Lentil", sprouting_s: 0.5, harvest_s: 3, harvest_f: 4)
...
PlantGrowth.create(name: "Mustard", germinate_s: 0.2, flowering_s: 1.5)
PlantGrowth.create(name: "Tulsi", germinate_s: 0.75, outside_s: 1.5, outside_f: 2)
